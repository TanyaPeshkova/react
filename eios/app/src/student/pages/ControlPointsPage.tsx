    ...
    return <div className="container-md container-fluid mt-5 pe-2 ps-2 pe-md-1 ps-md-1">
      ...
      <div className="students-kt">
        ...
        <table className="table">
          ...
          <tbody>
            <FilterComponent onSearch={this.search} onClick={this.handleClick}/>
...
class FilterComponent extends React.Component<FilterInteface> {
  render() {
    ...
    return <tr>
      ...
      <th>    <div className="dropdown">
        ...
        <ul className="dropdown-menu">
          <li><button className="dropdown-item" onClick={e => {onClick('all')}}>Все</button></li>
