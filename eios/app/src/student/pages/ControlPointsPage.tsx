                        ...
                        <th>
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <button className="dropdown-item" onClick={e => this.allPoint()}>Все</button>
                                    </li>
                                    <li>
                                        <button className="dropdown-item" onClick={e => this.excellentPoint()}>Отлично
                                        </button>
                                    </li>
                                    <li>
                                        <button className="dropdown-item" onClick={e => this.goodPoint()}>Хорошо
                                        </button>
                                    </li>
                                    <li>
                                        <button className="dropdown-item"
                                                onClick={e => this.wellPoint()}>Удовлетворительно
                                        </button>
                                    </li>
                                    <li>
                                        <button className="dropdown-item"
